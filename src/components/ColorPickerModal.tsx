      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col">
       ...
       <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between bg-white">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-semibold text-slate-900 text-base">Color Palette & Picker</h3>
              <p className="text-xs text-slate-500">Select or create colors for your animation</p>
            </div>
          </div>
          <button
            onClick={onClose}
